...
def get_params():
    params = {
        'weight': '/mnt/data/ningling/CODE/YOLO/for_yolov8v11v12/result0618_4/my_yolov11/yolo11s_2/weights/best.pt', # 现在只需要指定权重即可,不需要指定cfg
        'device': 'cuda:0',
        'method': 'HiResCAM', # GradCAMPlusPlus, GradCAM, XGradCAM, EigenCAM, HiResCAM, LayerCAM, RandomCAM, EigenGradCAM, KPCA_CAM
        'layer': [18],
        # 'layer': [18],
...
if __name__ == '__main__':
    ...
    model(r"/mnt/data/ningling/DATASET/dataset_yolo_all_fracture/test_out/images/", "./heatmaps")
