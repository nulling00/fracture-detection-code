...
if __name__ == "__main__":
    ...
    model_path      = '/mnt/data/yanmingshuo/CODE/faster-rcnn-pytorch-master/logs_for_vgg_2/ep025-loss1.179-val_loss0.668.pth'
    # model_path      = '/mnt/data/yanmingshuo/CODE/faster-rcnn-pytorch-master/model_data/voc_weights_vgg.pth'
