...
def evaluate_model(model_path, val_dataset_path, conf_threshold=0.01, 
    ...
    np.savetxt('array_numpy2.txt', scores, fmt='%.6f', delimiter=' ')
    np.savetxt('array_numpy2labels.txt', labels, fmt='%.6f', delimiter=' ')
...
if __name__ == "__main__":
    model_path = '/mnt/data/ningling/CODE/YOLO/for_yolov8v11v12/result/my_yolov11/yolo11s/weights/best.pt'
    val_dataset_path = "/mnt/data/ningling/DATASET/dataset_yolo_all_fracture/test_all"
    
    # 配置输出文件名称
    roc_image_file = "yolov11s_testout_roc_curve.png"
    pr_image_file = "yolov11s_testout_pr_curve.png"
    cm_image_file = "yolov11s_testout_confusion_matrix.png"
    metrics_text_file = "yolov11s_testout_detailed_metrics.txt"
