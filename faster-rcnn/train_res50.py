...
if __name__ == "__main__":
    ...
    # model_path      = 'model_data/voc_weights_resnet101.pth'
    # model_path      = '/mnt/data/yanmingshuo/CODE/faster-rcnn-pytorch-master/model_data/trained_pth/best_epoch_weights_resnet50.pth'
    model_path      = '/mnt/data/yanmingshuo/CODE/faster-rcnn-pytorch-master/logs_for_res50/best_epoch_weights.pth'
